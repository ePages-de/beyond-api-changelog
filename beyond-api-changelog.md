...
* `GET` /order-settings List order settings  
    Return Type
        ...
        Delete customInvoiceCorrectionMailText //A customizable text body for the email that is sent to the customer with the invoice correction or cancellation pdf attached. Merchants can adapt the email body to their needs in case the default text does not meet their requirements.
